...
[![LiaScript Course](https://raw.githubusercontent.com/LiaScript/LiaScript/master/badges/course.svg)](https://liascript.github.io/course/?https://raw.githubusercontent.com/Ifi-Softwareentwicklung-SoSe2026/exercise-06-4th-test-smn-hrtzsch/refs/heads/main/README.md)
...
class Bauvorhaben {
  ...
  +void ZuweiseFlaeche(Bauflaeche flaeche)
...
Bauvorhaben "*" -- "1" Antragsteller : wird beantragt von
...
Die Anwendung nutzt vier zentrale Domänenklassen:

- `Grundstueck` sammelt Stammdaten und die zugehörigen Bauflächen.
- `Bauflaeche` beschreibt Größe, Lage, Nutzung, Bebaubarkeit, B-Plan-Daten und Status einer Fläche.
- `Bauvorhaben` verbindet Antragsteller, geplante Nutzung, Zeitplan, Status und zugeordnete Bauflächen.
- `Antragsteller` enthält Name, Kontaktdaten und optional eine Firma.

Damit ist nachvollziehbar, wie Grundstücke, Bauflächen und Bauvorhaben fachlich zusammenhängen.
